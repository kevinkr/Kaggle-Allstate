...
cat(paste0('Model CV-MAE: ',cv_mae,' '," Train-MAE: ", train_mae, " best rounds:", best_nrounds1, "   MAE: ", mae_val))
...
write.csv(submission,file = 'Submissions/xgb-mybasic-v3-12-2-16.csv',row.names = FALSE)
